  ...
  return (
    <div className="min-h-screen bg-[#272724]">
      ...
      <div className="w-full min-h-screen relative overflow-hidden">
        {/* Grid Background for Hero Section only */}
        ...
        <section className="relative w-full max-w-[1440px] mx-auto px-4 sm:px-6 z-20">
          <div className="relative min-h-[1000px] pt-8 sm:pt-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 sm:mt-20">
              <div className="bg-[#23241f] border border-white rounded-2xl p-8 flex flex-col justify-center min-h-[180px]">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-2">1</div>
                <div className="font-bold text-white text-lg sm:text-xl mb-1">Secure Command Sync</div>
                <div className="text-gray-400 text-base sm:text-lg leading-relaxed font-normal">Sync your commands across devices with end-to-end encryption.</div>
              </div>
              <div className="bg-[#23241f] border border-white rounded-2xl p-8 flex flex-col justify-center min-h-[180px]">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-2">2</div>
                <div className="font-bold text-white text-lg sm:text-xl mb-1">Context-Rich Search</div>
                <div className="text-gray-400 text-base sm:text-lg leading-relaxed font-normal">Find any command instantly, with full project and environment context.</div>
              </div>
              <div className="bg-[#23241f] border border-white rounded-2xl p-8 flex flex-col justify-center min-h-[180px]">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-2">3</div>
                <div className="font-bold text-white text-lg sm:text-xl mb-1">Collaboration Tools</div>
                <div className="text-gray-400 text-base sm:text-lg leading-relaxed font-normal">Share, annotate, and manage command history as a team.</div>
              </div>
            </div>
